                    ...
                    <tr>
                        <td style="padding:40px 40px 32px;">
                            ...
                            <p style="color:#1F2937; font-size:15px; line-height:1.8; margin:0 0 8px;">
                                Halo, selamat datang di <strong style="color:#15423C;">Zad Apps</strong>! &#127881;
                            </p>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <p style="color:#78350F; font-size:12px; line-height:1.5; margin:0;">
                                                        Pihak Zad Apps tidak pernah meminta kode OTP. Waspada penipuan.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td style="padding:24px 40px;">
                            <p style="color:#9CA3AF; font-size:12px; line-height:1.7; margin:0; text-align:center;">
                                ...
                                Akun Anda aman dan tidak ada yang perlu dikhawatirkan.
                            </p>
                        </td>
                    </tr>
